        ...
        <table class="table table-hover" className={style.tblTaskEditDelete}>
          <thead>
            <tr>
              ...
              <th style={{ width: "12vw" }}>ROOMBOY Name</th>
          ...
          >
            {taskData.map((task) => (
              <tr>
                ...
                <td style={{ width: "10vw" }}>{task.RoomboyNumber}</td>
                <td style={{ width: "10vw" }}>{task.Type}</td>
                <td style={{ width: "10vw" }}>{task.Date}</td>
                <td style={{ width: "10vw" }}>{task.Time}</td>
                <td style={{ width: "20vw" }}>{task.SpecialNotes}</td>
